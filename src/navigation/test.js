...
const Product = (props) => {
  ...
  const [image, setImage] = useState(props.route.params.Img);
  const [active, setactive] = useState("ناموجودکن");
  ...
  const getDetailsproductHandler = async () => {
    try {
      ...
      setact(act == DetailsProduct.in_stock ? true : false);
    } catch (err) {
      console.log(err);
    }
  };
  ...
  const sendPakeActiveHandler = async () => {
    try {
      setactive(active == "ناموجودکن" ? "موجودکن" : "ناموجودکن");
      setact(act == false ? true : false);
    } catch (err) {
      console.log(err);
    }
  };
          ...
          <ScrollView style={{ backgroundColor: Colors.background }}>
            ...
            >
              <INPU
                ...
                stylelabel={{ width: 70 }}
                value={separate(DetailsProduct.sale_price)}
                onChangeText={(text) => updateState("sale_price", text)}
              ...
              <INPU
                ...
                styleview={{ width: "47%", left: 12 }}
                stylelabel={{ width: 75 }}
                value={separate(DetailsProduct.regular_price)}
                onChangeText={(text) => updateState("regular_price", text)}
                keyboardType="numeric"
              />
            </View>
            ...
            <View style={styles.viewselect}>
              ...
              <Select
                ...
                onValueChange={(text) => updateState("category_id", text)}
                _selectedItem={{
                  bg: Colors.primary,
            ...
            <View style={{ width: "100%", height: 250, alignItems: "center" }}>
              ...
              <View style={{ flexDirection: "row", width: "100%" }}>
                <INPU
                  ...
                  onChangeText={(text) =>
                    updateState("extra_food_addon_price_one", text)
                  }
                  keyboardType="numeric"
                />
                <INPU
                  ...
                  onChangeText={(text) =>
                    updateState("extra_food_addon_one", text)
                  }
                />
              </View>
              ...
              <View style={{ flexDirection: "row", width: "100%" }}>
                <INPU
                  ...
                  onChangeText={(text) =>
                    updateState("extra_food_addon_price_two", text)
                  }
                  keyboardType="numeric"
                />
                <INPU
                  ...
                  onChangeText={(text) =>
                    updateState("extra_food_addon_two", text)
                  }
                />
              </View>
              ...
              <View style={{ flexDirection: "row", width: "100%" }}>
                <INPU
                  ...
                  onChangeText={(text) =>
                    updateState("extra_food_addon_price_three", text)
                  }
                />
                <INPU
                  label="عنوان"
                  ...
                  onChangeText={(text) =>
                    updateState("extra_food_addon_three", text)
                  }
                />
              </View>
            </View>
            ...
            <View
              style={{
                ...
                top: 130,
                backgroundColor:
                  active == "ناموجودکن" ? Colors.success : Colors.primary,
              }}
            >
              <Text style={styles.mojodtext}>
                {" "}
                وضعیت موجودی محصول :{" "}
                {active == "ناموجودکن" ? "موجود" : "ناموجود "}
              </Text>
